...
export default {
  themes: [
    //TRANSPORT QUESTIONS//------------------------------------------------------------------------
    {
      ...
      question:
        "During your daily commute, what is your main method of transport?",
      options: [
...

    {
      ...
      question:
        "In the last year, how many long distance (more than 2500km) return flights have you made?",
      options: [
        { text: "None.", value: 0 },
...

    {
      ...
      name: "Food: Waste",
      question:
        "Out of the food you buy, how much would you say goes to waste each month?",
      options: [
        { text: "None.", value: 0 },
...

    {
      ...
      name: "Food: Sourcing",
      question:
        "In a typical month, how much of your food comes from local sources?",
      options: [
        { text: "None.", value: 4 },
        ...
        {
          text: "All of my food is locally sourced, and organic too!",
          value: 0,
        },
      ],
    },
    ...
    //GOODS QUESTIONS//----------------------------------------------------------------------------
    {
      ...
      question:
        "In a typical month, how much do you spend on new electronics and applicances?",
      options: [
...

    {
      ...
      name: "Goods: Pets",
      question:
        "In a typical month, how much do you spend on pets and pet goods?",
      options: [
